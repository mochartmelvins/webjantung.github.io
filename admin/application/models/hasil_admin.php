...
if(isset($_POST['Cari'])){
 ...
 echo"<script>location.href='$_SERVER[PHP_SELF]?module=hasil_admin&stt=cari&txt=$txtcari&list=$listcari';</script>";
}
?>
...
if($nilai<$nilai_t){echo"dibawah Batas Threshold"; $T="K";}
 ...
 ?>
  ...
  <?php
	...
	<a href="<?php echo "$_SERVER[PHP_SELF]?module=hasil_pakar&stt=hapus&id=".$r['id_konsultasi'] ?>" onClick='return confirm("Apakah Ada yakin menghapus?")'><i class="ti-trash"></i></a>
  <?php $id_konsultasi=$r["id_konsultasi"]; ?>
  <a href="media.php?module=tampil_detail&mn=hasil_admin&idk=<?php echo $id_konsultasi ;?>" class="menu"><i class="ti-view-list"></i></a></td> 
 ...
 ?>
  ...
  <a href="<?php echo"$_SERVER[PHP_SELF]?module=hasil_admin";?>"><button type="button" class="btn btn-primary mb-3">Kembali</button></a>                             
                            </div>
