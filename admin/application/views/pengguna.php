...
?>
 ...
 <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                   ...
                   <div class="x_title">
						<a href="dashboard.php?module=pengguna&stt=tambah" class="menu"><button type="button" class="btn btn-primary mb-3">Tambah Data</button></a>
...
";
  ...
  <td align="center">
   <a href="<?php echo "$_SERVER[PHP_SELF]?module=pengguna&stt=edit&id=".$r['id_pengguna'] ?>"><i class="fa fa-edit"></i></a> 
									...
									<form id="demo-form2" method="post" action="" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<a href="dashboard.php?module=pengguna"><button class="btn btn-primary" type="button">Batal</button></a>
...
if(isset($_POST['Simpan'])){
  ...
  if($querytambah) {
   ...
   echo"<script>location.href='$_SERVER[PHP_SELF]?module=pengguna';</script>";
   
   
   } else{
   echo"<script>alert('Data Gagal di Input');location.href='$_SERVER[PHP_SELF]?module=pengguna';</script>";
...
$queryupdate = mysqli_query($koneksi, "UPDATE tbpengguna SET 
  ...
  if($queryupdate) {
   ...
   echo"<script>alert('Data Gagal di Update');location.href='$_SERVER[PHP_SELF]?module=pengguna&stt=edit&id=$id_pengguna';</script>";
