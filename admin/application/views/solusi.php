...
<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Solusi <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">

												<textarea name="nama_solusi" id="first-name" rows="10" cols="70" required="required" class="form-control "></textarea>
											</div>
										</div>
...
if(isset($_POST['Simpan'])){
  ...
  if($querytambah) {
   ...
   echo"<script>location.href='$_SERVER[PHP_SELF]?module=solusi';</script>";
...
<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
											   <textarea name="nama_solusi" rows="10" cols="70"  class="form-control " required="required"><?php echo $nama_solusi;?></textarea>
